"""
The implementation of SAITS for the partially-observed time-series classification task.
...
class SAITS(BaseNNClassifier):
    ...
    def fit(
        ...
        if val_set is not None:
            val_set = DatasetForSAITS(val_set, file_type=file_type)
