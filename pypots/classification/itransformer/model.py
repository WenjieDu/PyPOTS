"""
The implementation of iTransformer for the partially-observed time-series classification task.
...
class iTransformer(BaseNNClassifier):
    """The PyTorch implementation of the iTransformer classification model :cite:`liu2024itransformer`.
    ...
    def fit(
        ...
        training_set = DatasetForiTransformer(train_set, file_type=file_type)
        ...
        if val_set is not None:
            val_set = DatasetForiTransformer(val_set, file_type=file_type)
    ...
    def predict(
        ...
        test_set = DatasetForiTransformer(
            test_set,
            return_y=False,
            file_type=file_type,
        )
