...
class _BRITS(imputation_BRITS, nn.Module):
    ...
    def forward(self, inputs):
        ...
        ret_f['classification_loss'] = F.nll_loss(ret_f['prediction'], inputs['label'])
        ret_b['classification_loss'] = F.nll_loss(ret_b['prediction'], inputs['label'])
...
class BRITS(BaseNNClassifier):
    ...
    def fit(self, train_X, train_y, val_X=None, val_y=None):
        ...
        self.model = _BRITS(seq_len, n_features, self.rnn_hidden_size, self.n_classes,
