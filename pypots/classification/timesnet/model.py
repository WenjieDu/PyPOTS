"""
The implementation of TimesNet for the partially-observed time-series classification task.
...
class TimesNet(BaseNNClassifier):
    """The PyTorch implementation of the TimesNet classification model :cite:`wu2023timesnet`.
    ...
    def fit(
        ...
        training_set = DatasetForTimesNet(train_set, file_type=file_type)
        ...
        if val_set is not None:
            val_set = DatasetForTimesNet(val_set, file_type=file_type)
