"""
The implementation of MICN for the partially-observed time-series forecasting task.
...
class MICN(BaseNNForecaster):
    """The PyTorch implementation of the MICN model :cite:`wang2023micn` for time series forecasting.
