"""
The implementation of FiLM for the partially-observed time-series forecasting task.
...
class FiLM(BaseNNForecaster):
    """The PyTorch implementation of the FiLM model :cite:`zhou2022film` for time series forecasting.
