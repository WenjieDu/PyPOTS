...
class TimeMixerPP(BaseNNForecaster):
    """The PyTorch implementation of the TimeMixer++ forecasting model :cite:`wang2025timemixerpp`.
    ...
    n_heads :
        ...
        Only works if channel_mixing is True.
