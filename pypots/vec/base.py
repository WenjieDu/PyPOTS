...
class BaseNNVectorizer(BaseNNModel):
    ...
    def __init__(
        ...
        # training loss function and validation metric function are quite different in vectorizer models,
    ...
    def _assemble_input_for_testing(self, data: list) -> dict:
        ...
        vectorization task contains labels, but the testing data (from the production environment) generally
        doesn't have labels.
