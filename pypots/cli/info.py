...
def info_command_factory(args: Namespace):
    return InfoCommand()


class InfoCommand(BaseCommand):
    """CLI command that prints PyPOTS version, environment, and device information.
    ...
    def register_subcommand(parser):
        sub_parser = parser.add_parser(
            "info",
            help="Display PyPOTS version, environment, and device information",
        )
        sub_parser.set_defaults(func=info_command_factory)
    ...
    def run(self):
        ...
        optional_deps = {
            ...
            "nni": "NNI (hyperparameter optimization)",
