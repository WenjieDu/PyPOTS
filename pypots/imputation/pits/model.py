"""
The implementation of PITS for the partially-observed time-series imputation task.

Refer to the paper "Seunghan Lee, Taeyoung Park, and Kibok Lee.
...
class PITS(BaseNNImputer):
    """The PyTorch implementation of the PITS model :cite:`lee2024pits`.
    ...
    n_layers :
        The number of independent patch-processing layers in the PITS model.

    d_model :
        The dimension of the model.

    d_ffn :
        The dimension of the feed-forward network in each patch-processing block.
