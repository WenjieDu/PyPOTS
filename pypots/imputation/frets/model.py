...
from .core import _FreTS
from .data import DatasetForFreTS
...
class FreTS(BaseNNImputer):
    """The PyTorch implementation of the FreTS model.
    ...
    embed_size :
        ...
        The default value is 128, the same as the fixed one in the original implementation.

    hidden_size :
        The size of the hidden layer in the FreTS model.
        The default value is 256, the same as the fixed one in the original implementation
    ...
    def fit(
        ...
        training_set = DatasetForFreTS(train_set, return_X_ori=False, return_y=False, file_type=file_type)
        ...
        if val_set is not None:
            ...
            val_set = DatasetForFreTS(val_set, return_X_ori=True, return_y=False, file_type=file_type)
