...
from .core import _TiDE
from .data import DatasetForTiDE
...
class TiDE(BaseNNImputer):
    ...
    n_layers :
        The number of layers in the TiDE model.
    ...
    def __init__(
        ...
        self.d_temporal_decoder_hidden = d_temporal_decoder_hidden
    ...
    def fit(
        ...
        training_set = DatasetForTiDE(train_set, return_X_ori=False, return_y=False, file_type=file_type)
        ...
        if val_set is not None:
            ...
            val_set = DatasetForTiDE(val_set, return_X_ori=True, return_y=False, file_type=file_type)
