"""
The implementation of ImputeFormer for the partially-observed time-series anomaly detection task.
...
class ImputeFormer(BaseNNDetector):
    """The PyTorch implementation of the ImputeFormer model :cite:`nie2024imputeformer` on the anomaly detection task.
