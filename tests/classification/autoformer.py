"""
Test cases for Autoformer classification model.
"""
...
from pypots.classification import Autoformer
...
class TestAutoformer(unittest.TestCase):
    logger.info("Running tests for a classification model Autoformer...")

    # set the log and model saving path
    saving_path = os.path.join(RESULT_SAVING_DIR_FOR_CLASSIFICATION, "Autoformer")
    ...
    @pytest.mark.xdist_group(name="classification-autoformer")
    def test_0_fit(self):
    ...
    def test_4_lazy_loading(self):
        ...
        classification_proba = self.autoformer.predict_proba(GENERAL_H5_TEST_SET_PATH)
        classification = self.autoformer.classify(GENERAL_H5_TEST_SET_PATH)
