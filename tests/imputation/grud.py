"""
Test cases for GRUD imputation model.
"""
...
class TestGRUD(unittest.TestCase):
    logger.info("Running tests for an imputation model GRUD...")

    # set the log and model saving path
    saving_path = os.path.join(RESULT_SAVING_DIR_FOR_IMPUTATION, "GRUD")
    ...
    def test_4_lazy_loading(self):
        ...
        imputation_results = self.grud.predict(GENERAL_H5_TEST_SET_PATH)
        assert not np.isnan(
        ...
        logger.info(f"Lazy-loading GRUD test_MSE: {test_MSE}")
