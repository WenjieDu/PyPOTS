"""
Test cases for Crossformer imputation model.
"""
...
class TestCrossformer(unittest.TestCase):
    logger.info("Running tests for an imputation model Crossformer...")

    # set the log and model saving path
    saving_path = os.path.join(RESULT_SAVING_DIR_FOR_IMPUTATION, "Crossformer")
    model_save_name = "saved_crossformer_model.pypots"

    # initialize an Adam optimizer
    optimizer = Adam(lr=0.001, weight_decay=1e-5)

    # initialize a Crossformer model
    ...
    def test_1_impute(self):
        imputation_results = self.crossformer.predict(TEST_SET)
        assert not np.isnan(
        ...
        logger.info(f"Crossformer test_MSE: {test_MSE}")
    ...
    def test_4_lazy_loading(self):
        ...
        logger.info(f"Lazy-loading Crossformer test_MSE: {test_MSE}")
