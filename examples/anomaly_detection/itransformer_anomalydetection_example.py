"""
A minimalist, standalone example of the PyPOTS iTransformer model for time-series anomaly detection.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the iTransformer anomaly detection model...")
    ...
    print(f"✅ iTransformer anomaly detection - Accuracy: {accuracy:.4f}, F1: {f1:.4f}, Precision: {precision:.4f}, Recall: {recall:.4f}")
