"""
A minimalist, standalone example of the PyPOTS Reformer model for time-series anomaly detection.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Reformer anomaly detection model...")
    ...
    print(f"✅ Reformer anomaly detection - Accuracy: {accuracy:.4f}, F1: {f1:.4f}, Precision: {precision:.4f}, Recall: {recall:.4f}")
