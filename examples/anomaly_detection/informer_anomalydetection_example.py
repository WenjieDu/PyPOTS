"""
A minimalist, standalone example of the PyPOTS Informer model for time-series anomaly detection.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Informer anomaly detection model...")
    ...
    print(f"✅ Informer anomaly detection - Accuracy: {accuracy:.4f}, F1: {f1:.4f}, Precision: {precision:.4f}, Recall: {recall:.4f}")
