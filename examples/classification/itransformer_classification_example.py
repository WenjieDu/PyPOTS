"""
A minimalist, standalone example of the PyPOTS iTransformer model for time-series classification.
...
def main():
    ...
    print(f'✅ iTransformer classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
