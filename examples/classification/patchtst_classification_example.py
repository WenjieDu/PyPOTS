"""
A minimalist, standalone example of the PyPOTS PatchTST model for time-series classification.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the PatchTST model...")
    ...
    print(f'✅ PatchTST classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
