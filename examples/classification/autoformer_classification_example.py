"""
A minimalist, standalone example of the PyPOTS Autoformer model for time-series classification.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Autoformer model...")
    ...
    print(f'✅ Autoformer classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
