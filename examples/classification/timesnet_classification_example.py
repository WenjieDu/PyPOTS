"""
A minimalist, standalone example of the PyPOTS TimesNet model for time-series classification.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the TimesNet model...")
    ...
    print(f'✅ TimesNet classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
