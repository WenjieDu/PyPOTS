"""
A minimalist, standalone example of the PyPOTS TEFN model for time-series classification.
...
def main():
    ...
    print(f'✅ TEFN classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
