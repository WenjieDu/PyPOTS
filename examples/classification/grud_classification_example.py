"""
A minimalist, standalone example of the PyPOTS GRUD model for time-series classification.
...
def main():
    ...
    print(f'✅ GRUD classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
