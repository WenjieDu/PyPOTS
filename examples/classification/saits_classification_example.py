"""
A minimalist, standalone example of the PyPOTS SAITS model for time-series classification.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the SAITS model...")
    ...
    print(f'✅ SAITS classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
