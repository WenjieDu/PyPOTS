"""
A minimalist, standalone example of the PyPOTS Raindrop model for time-series classification.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Raindrop model...")
    ...
    print(f'✅ Raindrop classification ROC_AUC: {metrics["roc_auc"]:.4f}, '
