"""
A minimalist, standalone example of the PyPOTS Median model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Median model...")
    ...
    print(f"✅ The MSE of Median imputation is: {mse:.4f}")
