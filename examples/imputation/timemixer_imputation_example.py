"""
A minimalist, standalone example of the PyPOTS TimeMixer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the TimeMixer model...")
    ...
    print(f"✅ The MSE of TimeMixer imputation is: {mse:.4f}")
