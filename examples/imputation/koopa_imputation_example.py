"""
A minimalist, standalone example of the PyPOTS Koopa model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Koopa model...")
    ...
    print(f"✅ The MSE of Koopa imputation is: {mse:.4f}")
