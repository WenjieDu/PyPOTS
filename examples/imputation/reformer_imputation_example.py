"""
A minimalist, standalone example of the PyPOTS Reformer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Reformer model...")
    ...
    print(f"✅ The MSE of Reformer imputation is: {mse:.4f}")
