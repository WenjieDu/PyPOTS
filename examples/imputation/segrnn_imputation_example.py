"""
A minimalist, standalone example of the PyPOTS SegRNN model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the SegRNN model...")
    ...
    print(f"✅ The MSE of SegRNN imputation is: {mse:.4f}")
