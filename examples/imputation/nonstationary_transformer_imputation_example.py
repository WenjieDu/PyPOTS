"""
A minimalist, standalone example of the PyPOTS NonstationaryTransformer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the NonstationaryTransformer model...")
    ...
    print(f"✅ The MSE of NonstationaryTransformer imputation is: {mse:.4f}")
