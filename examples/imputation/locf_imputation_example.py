"""
A minimalist, standalone example of the PyPOTS LOCF model for time-series imputation.
...
def main():
    ...
    model = LOCF(first_step_imputation="zero", device="cpu")

    # 4. Train the model
    print("🚀 Training the LOCF model...")
    ...
    print(f"✅ The MSE of LOCF imputation is: {mse:.4f}")
