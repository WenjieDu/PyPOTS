"""
A minimalist, standalone example of the PyPOTS ETSformer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the ETSformer model...")
    ...
    print(f"✅ The MSE of ETSformer imputation is: {mse:.4f}")
