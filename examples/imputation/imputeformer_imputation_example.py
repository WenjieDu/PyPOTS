"""
A minimalist, standalone example of the PyPOTS ImputeFormer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the ImputeFormer model...")
    ...
    print(f"✅ The MSE of ImputeFormer imputation is: {mse:.4f}")
