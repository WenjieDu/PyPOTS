"""
A minimalist, standalone example of the PyPOTS HELIX model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the HELIX model...")
    ...
    print(f"✅ The MSE of HELIX imputation is: {mse:.4f}")
