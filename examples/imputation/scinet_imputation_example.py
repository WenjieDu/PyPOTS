"""
A minimalist, standalone example of the PyPOTS SCINet model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the SCINet model...")
    ...
    print(f"✅ The MSE of SCINet imputation is: {mse:.4f}")
