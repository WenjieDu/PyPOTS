"""
A minimalist, standalone example of the PyPOTS GPT4TS model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the GPT4TS model...")
    ...
    print(f"✅ The MSE of GPT4TS imputation is: {mse:.4f}")
