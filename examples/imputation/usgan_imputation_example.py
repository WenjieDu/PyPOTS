"""
A minimalist, standalone example of the PyPOTS USGAN model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the USGAN model...")
    ...
    print(f"✅ The MSE of USGAN imputation is: {mse:.4f}")
