"""
A minimalist, standalone example of the PyPOTS Crossformer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Crossformer model...")
    ...
    print(f"✅ The MSE of Crossformer imputation is: {mse:.4f}")
