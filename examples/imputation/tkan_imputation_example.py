"""
A minimalist, standalone example of the PyPOTS TKAN model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of TKAN imputation is: {mse:.4f}")
