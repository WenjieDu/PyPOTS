"""
A minimalist, standalone example of the PyPOTS RevIN_SCINet model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the RevIN_SCINet model...")
    ...
    print(f"✅ The MSE of RevIN_SCINet imputation is: {mse:.4f}")
