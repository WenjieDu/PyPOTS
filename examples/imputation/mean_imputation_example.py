"""
A minimalist, standalone example of the PyPOTS Mean model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of Mean imputation is: {mse:.4f}")
