"""
A minimalist, standalone example of the PyPOTS FEDformer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the FEDformer model...")
    ...
    print(f"✅ The MSE of FEDformer imputation is: {mse:.4f}")
