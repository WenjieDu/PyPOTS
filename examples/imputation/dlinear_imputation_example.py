"""
A minimalist, standalone example of the PyPOTS DLinear model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the DLinear model...")
    ...
    print(f"✅ The MSE of DLinear imputation is: {mse:.4f}")
