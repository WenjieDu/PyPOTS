"""
A minimalist, standalone example of the PyPOTS TiDE model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of TiDE imputation is: {mse:.4f}")
