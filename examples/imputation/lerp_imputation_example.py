"""
A minimalist, standalone example of the PyPOTS Lerp model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of Lerp imputation is: {mse:.4f}")
