"""
A minimalist, standalone example of the PyPOTS MRNN model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of MRNN imputation is: {mse:.4f}")
