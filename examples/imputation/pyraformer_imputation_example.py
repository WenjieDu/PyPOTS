"""
A minimalist, standalone example of the PyPOTS Pyraformer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Pyraformer model...")
    ...
    print(f"✅ The MSE of Pyraformer imputation is: {mse:.4f}")
