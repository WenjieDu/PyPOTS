"""
A minimalist, standalone example of the PyPOTS FiLM model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of FiLM imputation is: {mse:.4f}")
