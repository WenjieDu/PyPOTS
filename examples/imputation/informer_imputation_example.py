"""
A minimalist, standalone example of the PyPOTS Informer model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the Informer model...")
    ...
    print(f"✅ The MSE of Informer imputation is: {mse:.4f}")
