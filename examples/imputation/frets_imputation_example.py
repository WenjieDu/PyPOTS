"""
A minimalist, standalone example of the PyPOTS FreTS model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the FreTS model...")
    ...
    print(f"✅ The MSE of FreTS imputation is: {mse:.4f}")
