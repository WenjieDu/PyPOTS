"""
A minimalist, standalone example of the PyPOTS TimeMixerPP model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the TimeMixerPP model...")
    ...
    print(f"✅ The MSE of TimeMixerPP imputation is: {mse:.4f}")
