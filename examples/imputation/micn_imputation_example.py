"""
A minimalist, standalone example of the PyPOTS MICN model for time-series imputation.
...
def main():
    ...
    print(f"✅ The MSE of MICN imputation is: {mse:.4f}")
