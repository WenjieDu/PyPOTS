"""
A minimalist, standalone example of the PyPOTS StemGNN model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the StemGNN model...")
    ...
    print(f"✅ The MSE of StemGNN imputation is: {mse:.4f}")
