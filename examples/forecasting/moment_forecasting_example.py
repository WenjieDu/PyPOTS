"""
A minimalist, standalone example of the PyPOTS MOMENT model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the MOMENT forecasting model...")
    ...
    print(f"✅ MOMENT forecasting MSE: {test_MSE:.4f}")
