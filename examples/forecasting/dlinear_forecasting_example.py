"""
A minimalist, standalone example of the PyPOTS DLinear model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the DLinear forecasting model...")
    ...
    print(f"✅ DLinear forecasting MSE: {test_MSE:.4f}")
