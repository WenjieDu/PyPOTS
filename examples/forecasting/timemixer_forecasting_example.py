"""
A minimalist, standalone example of the PyPOTS TimeMixer model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the TimeMixer forecasting model...")
    ...
    print(f"✅ TimeMixer forecasting MSE: {test_MSE:.4f}")
