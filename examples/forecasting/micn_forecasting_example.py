"""
A minimalist, standalone example of the PyPOTS MICN model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the MICN forecasting model...")
    ...
    print(f"✅ MICN forecasting MSE: {test_MSE:.4f}")
