"""
A minimalist, standalone example of the PyPOTS GPT4TS model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the GPT4TS forecasting model...")
    ...
    print(f"✅ GPT4TS forecasting MSE: {test_MSE:.4f}")
