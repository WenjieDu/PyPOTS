"""
A minimalist, standalone example of the PyPOTS TimeMixerPP model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the TimeMixerPP forecasting model...")
    ...
    print(f"✅ TimeMixerPP forecasting MSE: {test_MSE:.4f}")
