"""
A minimalist, standalone example of the PyPOTS TimesNet model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the TimesNet forecasting model...")
    ...
    print(f"✅ TimesNet forecasting MSE: {test_MSE:.4f}")
