"""
A minimalist, standalone example of the PyPOTS FITS model for time-series forecasting.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the FITS forecasting model...")
    ...
    print(f"✅ FITS forecasting MSE: {test_MSE:.4f}")
